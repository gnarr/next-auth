...
function oAuthClient(provider) {
  ...
  var originalGet = oauth1Client.get;
  ...
  var originalGetOAuth1AccessToken = oauth1Client.getOAuthAccessToken;
  ...
  var originalGetOAuthRequestToken = oauth1Client.getOAuthRequestToken;
