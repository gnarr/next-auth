...
function _getAuthorizationUrl() {
  _getAuthorizationUrl = _asyncToGenerator(function* (req) {
    ...
    if ((_provider$version = provider.version) !== null && _provider$version !== void 0 && _provider$version.startsWith('2.')) {
      var url = client.getAuthorizeUrl(_objectSpread(_objectSpread(_objectSpread({}, provider.authorizationParams), req.body.authorizationParams), {}, {
    ...
    try {
      var oAuthToken = yield client.getOAuthRequestToken(provider.callbackUrl);
